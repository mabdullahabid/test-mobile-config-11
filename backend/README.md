...
## Project Structure
    ...
    ├── test_mobile_config_11  # Django project configurations
...
1. Clone this repo and `cd test_mobile_config_11`
...
2. Clone this repo and `cd test_mobile_config_11`
